def rotate_image_90_degrees(matrix: [[int]]) -> [[int]]:
    ...
    (clockwise) by rotating each concentric layer in place, cycling four corresponding elements
    at a time. Try to solve this task in-place (with O(1) additional memory), since this is what
