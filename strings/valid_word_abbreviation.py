def valid_word_abbreviation(word: str, abbr: str) -> bool:
    ...
    "wor1", "2rd", "w2d", "wo2", "1o1d", "1or1", "w1r1", "1o2", "2r1", "3d", "w3", "4"]`. Notice that only the
    above abbreviations are valid abbreviations of the string "word". Any other string is not a valid
    abbreviation of "word".

    Note: assume the word contains only lowercase letters, and the abbreviation contains only lowercase letters
    and digits.
